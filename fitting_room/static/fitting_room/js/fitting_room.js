document.addEventListener('DOMContentLoaded', function () {
    ...
    let currentScale = 1;
    console.log("DOM fully loaded - fitting_room.js executing");
    ...
    if (clothingModal) {
        // debug: remove aria-hidden and set proper attributes
        clothingModal.removeAttribute('aria-hidden');
        clothingModal.setAttribute('aria-modal', 'true');

        // modal event listeners for proper focus management
